...
var connected_peers = [];
function connect () {
    easyrtc.setPeerListener (add_to_conversation); // Is called whenever there is sent data to this peer
    easyrtc.setRoomOccupantListener (convert_list_to_buttons); // Is called every time a user joins the room
...
function convert_list_to_buttons (roomName, data, isPrimary) {
    clear_connect_list ();
    connected_peers = [];
    var other_client_div = document.getElementById ("other_clients");
...
function add_to_conversation (who, msg_type, content) { // This function is used to add messages to the 'conversation' div
